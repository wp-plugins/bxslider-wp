	...
	*/
	public function __construct() {
		parent::__construct(
			...
			__( 'BxSlider Widget', 'bxslider' ), // Name
			array( 'description' => __( 'Widget for displaying sliders.', 'bxslider' ), ) // Args
		);
	}
...
?>
		...
		?>
			<label for="<?php echo $this->get_field_id('slider'); ?>"><?php _e('Select a slider:', 'bxslider'); ?></label>
		...
		<?php else: ?>
			<?php _e('No sliders found.', 'bxslider'); ?>
		<?php endif; ?>
		</p>
<?php
