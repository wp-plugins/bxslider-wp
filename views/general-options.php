...
<div class="bxslider-field">
	<label for="bxslider_options_mode"><?php _e('Mode:', 'bxslider'); ?></label>
	...
	<span class="note"><?php _e('Type of transition between slides.', 'bxslider'); ?></span>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_speed"><?php _e('Speed:', 'bxslider'); ?> </label>
	<input id="bxslider_options_speed" type="number" name="bxslider[options][speed]" value="<?php echo esc_attr($options['speed']); ?>" />
	<br /><span class="note"><?php _e('Slide transition duration (in ms).', 'bxslider'); ?></span>
	<div class="clear"></div>
</div>

<div class="bxslider-field">
	<label for="bxslider_options_random_start"><?php _e('Random Start:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_random_start" class="note"><?php _e('Start slider on a random slide.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>

<div class="bxslider-field">
	<label for="bxslider_options_infinite_loop"><?php _e('Infinite Loop:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_infinite_loop" class="note"><?php _e('If checked, clicking "Next" while on the last slide will transition to the first slide and vice-versa.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_hide_control_on_end"><?php _e('Hide Control On End:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_hide_control_on_end" class="note"><?php _e('If checked, "Next" control will be hidden on last slide and vice-versa. Note: Only used when Infinite Loop is unchecked.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_captions"><?php _e('Captions:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_captions" class="note"><?php _e('Include image captions.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_ticker"><?php _e('Ticker:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_ticker" class="note"><?php _e('Use slider in ticker mode (similar to a news ticker).', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_ticker_hover"><?php _e('Ticker Hover:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_ticker_hover" class="note"><?php _e('Ticker will pause when mouse hovers over slider. Note: this functionality does NOT work if using CSS transitions!', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
...
<div class="bxslider-field">
	<label for="bxslider_options_video"><?php _e('Video:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_video" class="note"><?php _e('Check this if any slides contain a video.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_responsive"><?php _e('Responsive:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_responsive" class="note"><?php _e('Enable or disable auto resize of the slider. Useful if you need to use fixed width sliders.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
...
<div class="bxslider-field">
	<label for="bxslider_options_easing"><?php _e('Easing:', 'bxslider'); ?></label>
	<select id="bxslider_options_easing" name="bxslider[options][easing]">
	<?php echo $easing_options; ?>
	</select>
	<span class="note"><?php _e('The type of "easing" to use during transitions.', 'bxslider'); ?></span>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_preload_images"><?php _e('Preload Images:', 'bxslider'); ?></label>
	...
	<span class="note"><?php _e('If "all", preloads all images before starting the slider. If "visible", preloads only images in the initially visible slides before starting the slider (tip: use "visible" if all slides are identical dimensions).', 'bxslider'); ?></span>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_touch_enabled"><?php _e('Touch Enabled:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_touch_enabled" class="note"><?php _e('If checked, slider will allow touch swipe transitions.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_swipe_threshold"><?php _e('Swipe Threshold:', 'bxslider'); ?> </label>
	...
	<span class="note"><?php _e('Amount of pixels a touch swipe needs to exceed in order to execute a slide transition. Note: Only used if Touch Enabled is checked.', 'bxslider'); ?></span>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_one_to_one_touch"><?php _e('One To One Touch:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_one_to_one_touch" class="note"><?php _e('If checked, non-fade slides follow the finger as it swipes.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_prevent_default_swipe_x"><?php _e('Prevent Default Swipe X:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_prevent_default_swipe_x" class="note"><?php _e('If checked, touch screen will not move along the x-axis as the finger swipes.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_prevent_default_swipe_y"><?php _e('Prevent Default Swipe Y:', 'bxslider'); ?> </label>
	...
	<label for="bxslider_options_prevent_default_swipe_y" class="note"><?php _e('If checked, touch screen will not move along the y-axis as the finger swipes.', 'bxslider'); ?></label>
	<div class="clear"></div>
</div>
<div class="bxslider-field">
	<label for="bxslider_options_slide_margin"><?php _e('Slide Margin:', 'bxslider'); ?> </label>
	...
	<br /><span class="note"><?php _e('Margin between each slide.', 'bxslider'); ?></span>
	<div class="clear"></div>
</div>
...
<div class="bxslider-field" style="display: none;">
	<label for="bxslider_options_start_slide"><?php _e('Start Slide:', 'bxslider'); ?> </label>
	...
	<br /><span class="note"><?php _e('Starting slide index (zero-based).', 'bxslider'); ?></span>
	<div class="clear"></div>
</div>