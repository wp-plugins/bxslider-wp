...
<div class="bxslider-slide">
	<div class="bxslider-header">
		...
		<span class="bxslider-controls">
			<span class="bxslider-drag" title="<?php _e('Drag', 'bxslider'); ?>"><?php _e('Drag', 'bxslider'); ?></span>
			<span class="bxslider-toggle" title="<?php _e('Toggle', 'bxslider'); ?>"><?php _e('Toggle', 'bxslider'); ?></span>
			<span class="bxslider-delete" title="<?php _e('Delete', 'bxslider'); ?>"><?php _e('Delete', 'bxslider'); ?></span>
		</span>
		<div class="clear"></div>
	</div>
	<div class="bxslider-body">
		<div class="bxslider-slide-type-bar">
			<select class="bxslider-slide-type-switcher" name="bxslider[slides][<?php echo $i; ?>][type]">
				<option value="image" <?php echo ('image'==$slide['type']) ? 'selected="selected"' : ''; ?>><?php _e('Image', 'bxslider'); ?></option>
				<option value="custom" <?php echo ('custom'==$slide['type']) ? 'selected="selected"' : ''; ?>><?php _e('Custom', 'bxslider'); ?></option>
			</select>	
		</div>
		...
		<div class="bxslider-image">
			<div class="bxslider-image-preview">
				...
				<input class="button-secondary bxslider-media-gallery-show" type="button" value="<?php _e('Get Image', 'bxslider'); ?>" />
			</div>
			<div class="bxslider-image-settings">
				<p class="expandable-group-title first"><?php _e('Slide Properties:', 'bxslider'); ?></p>
				<div class="expandable-box">
					<div class="expandable-header first"><?php _e('Link', 'bxslider'); ?></div>
					<div class="expandable-body">
						<div class="field">
							<label><?php _e('Enable Link:', 'bxslider'); ?></label> <br>
						...
						<div class="field">
							<label><?php _e('Link URL:', 'bxslider'); ?></label> <br>
							<input class="widefat" name="bxslider[slides][<?php echo $i; ?>][link]" type="text" value="<?php echo esc_url($slide['link']); ?>" />
						</div>
						<div class="field last">
							<label for=""><?php _e('Open Link in:', 'bxslider'); ?></label> <br>
							<select id="" name="bxslider[slides][<?php echo $i; ?>][link_target]">
								<option <?php echo ('_self'==$slide['link_target']) ? 'selected="selected"' : ''; ?> value="_self"><?php _e('Same Window', 'bxslider'); ?></option>
								<option <?php echo ('_blank'==$slide['link_target']) ? 'selected="selected"' : ''; ?> value="_blank"><?php _e('New Tab or Window', 'bxslider'); ?></option>
							</select>
						</div>
					</div>
				</div>
				<div class="expandable-box last">
					<div class="expandable-header"><?php _e('Caption', 'bxslider'); ?></div>
					<div class="expandable-body">
						<div class="field last">
		...
		<div class="bxslider-custom">
			<div class="field last">
				<label for=""><?php _e('Custom HTML', 'bxslider'); ?></label>
